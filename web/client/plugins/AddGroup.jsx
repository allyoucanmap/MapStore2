...
const AddGroupButton = connect(selector, {
    ...
    // TODO: this.getSelectedNodeDepth() <= this.props.maxDepth
    if (!status || [statusTypes.DESELECT, statusTypes.GROUP].includes(status)) {
        const parseParent = (value) => {
            return value === rootFolderId ? undefined : value;
        };
        ...
        return (
            <ItemComponent
                ...
                onClick={() => onClick(parseParent(group))}
            />
        );
    }
    return null;
