...
class MetadataExplorerComponent extends React.Component {
    ...
    static defaultProps = {
        ...
        serviceTypes: [{ name: "csw", label: "CSW" }, { name: "wms", label: "WMS" }, { name: "wmts", label: "WMTS" }, { name: "tms", label: "TMS", allowedProviders: DEFAULT_ALLOWED_PROVIDERS }, { name: "wfs", label: "WFS" }, { name: "3dtiles", label: "3D Tiles" }, { name: "arcgis", label: "ArcGIS-MapServer" }],
        active: false,
        wrap: false,
        modal: true,
        wrapWithPanel: false,
