...
module.exports = {
    CreateNewMapPlugin: connect((state) => ({
        ...
        isLoggedIn: true, // state && state.security && state.security.user && state.security.user.enabled && !(state.browser && state.browser.mobile) && true || false,
        user: {role: 'ADMIN'} // state && state.security && state.security.user
    }))(CreateNewMap)
};
