...
const backgroundSelector = createSelector([mapSelector, layersSelector, backgroundControlsSelector, drawerEnabledControlSelector, mapTypeSelector, currentBackgroundSelector, tempBackgroundSelector, cssStatusSelector],
    (map, layers, controls, drawer, maptype, currentLayer, tempLayer, cssStatus) => ({
