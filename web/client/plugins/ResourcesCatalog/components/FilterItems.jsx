...
function FilterItem({
    ...
    if (field.type === 'divider') {
        return <div className="ms-filter-form-divider"></div>;
    }
    if (field.type === 'link') {
        return <div className="ms-filter-form-link"><a href={field.href}>{field.labelId && getMessageById(messages, field.labelId) || field.label}</a></div>;
    }
    if (field.type === 'filter') {
        ...
        const renderFacet = ({item, active, onChangeFacet, renderChild}) => {
            return (
                <div className="ms-facet-wrapper">
        ...
        const filterChild = () => {
            return field.items && field.items.map((item) => {
                ...
                return (
                    <div className={'ms-sub-filter-items'} key={item.uuid}>
                        {isFacet(item)
