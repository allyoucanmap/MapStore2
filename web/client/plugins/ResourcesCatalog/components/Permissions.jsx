...
function Permissions({
    ...
    return (
        <Box position="relative" ptb="sm">
            {showGroupsPermissions ? <Box className="ms-secondary-colors" plr="sm">
                <Box component="ul" display="flex" flexColumn flexGap="sm" ptb="sm" >
                    {permissionsEntires
                            ...
                            return (
                                <li key={`owner-${idx}`}>
                                    <Box display="flex" flexVerticalAlign flexGap="sm" >
                                        ...
                                        <Box className="ms-permissions-column">
                                            <Box className="ms-tag ms-main-colors" display="inline-flex" flexGap="xs" flexVerticalAlign plr="sm">
                                                <Text>
                                                    {item.avatar
                                                        ? <img src={item.avatar}/>
            ...
            <Box ptb="sm">
                <Box display="flex" flexGap="sm">
                    {!hasFiltrablePermissions && !editing ? null : <Box display="flex" flexFill flexGap="sm">
                        <FormControl
                    ...
                    {editing ? <Popover
                        placement="bottom"
                        content={
                            <Box className="shadow ms-main-colors" position="relative" display="flex" flexColumn style={{ width: 300, height: 300 }}>
                                ...
                                <Box position="relative" fill flexFill >
                                    {entriesTabs
                ...
                {hasFiltrablePermissions ? <Box display="flex" flexVerticalAlign flexGap="sm" row ptb="sm">
                    <Box flexFill>
            ...
            {(filteredEntries.length === 0 && filter) ?
                ...
                : null}
            {loading ? (
                <Box position="absolute" fill display="flex" flexItemsCenter overlay>
                    <Text fontSize="xxl">
                        <Spinner />
                    </Text>
                </Box>
