 ...
 * @prop {object[]} cfg.tabs configuration for the available tabs. The test automation identifier defaults to `dataset-view-sidepanel-tab-{id}` and a tab can override it with `data-ms-id`
            ...
            Component: connect(
                ...
                return (
                    <Component
                        ...
                        dataMsId={cardMsIdPrefix ? `${cardMsIdPrefix}-properties` : undefined}
                    />
                );
            }),
            doNotHide: true
