...
const formatCards = {
    ...
    CUSTOM: {
        ...
        || <div>
            <p><i><Message msgId="layerProperties.Click on edit button to add a new template."/></i>&nbsp;<Glyphicon glyph="pencil"/></p>
            <p><i><Message msgId="layerProperties.'Use \$\{ \} to wrap the properties you need to be displayed."/></i></p>
            <pre>
                <Message msgId="layerProperties.'The id of the feature is \$\{ properties.id \}"/>
            </pre>
        </div>
    }
};
