    ...
    getInfoFormat = (infoFormats) => {
        return Object.keys(infoFormats).map((infoFormat) => {
            ...
            return {
                id: infoFormat,
                head: {
                    preview: <Glyphicon glyph={this.props.formatCards[infoFormat].glyph || 'ext-empty'}/>,
                ...
                body: <div><div><Message msgId="layerProperties.Example of Response"/></div><br/><Body template={this.props.element.featureInfo && this.props.element.featureInfo.template || ''} /></div>
            };
        });
    }
            ...
            <span>
                ...
                <Portal>
                    <ResizableModal
                        ...
                        title={<Message msgId="layerProperties.Edit custom format"/>}
                        size="lg"
                        showFullscreen
