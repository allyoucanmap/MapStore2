...
class DockPanel extends React.Component {
    ...
    getHeaderButton() {
        ...
        const glyph = (
            <Button key="ms-header-glyph" className="square-button" style={{pointerEvents: 'none'}} bsStyle={this.props.bsStyle}>
                <Glyphicon glyph={this.props.glyph}/>
            </Button>
        );
        return this.props.position === 'right' ? [glyph, close] : [close, glyph];
    }
