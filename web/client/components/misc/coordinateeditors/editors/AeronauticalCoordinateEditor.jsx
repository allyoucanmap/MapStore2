...
class AeronauticalCoordinateEditor extends React.Component {
    ...
    render() {
        ...
        return (
            <FormGroup style={{display: "inline-flex", width: '100%' }}>
                <div style={{minWidth: 45, flex: 1, display: 'flex'}}>
                    <FormControl
                ...
                <div className="seconds" style={{display: 'flex', flex: 1, minWidth: 75 }}>
                    <FormControl
                ...
                <div style={{minWidth: 45 }}>
                    ...
                    <FormControl
                        ...
                        style={{ minWidth: 45, paddingLeft: 4, paddingRight: 4, flex: 1 }}>
