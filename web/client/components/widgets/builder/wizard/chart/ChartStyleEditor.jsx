        ...
        return (
            <>
                <FormGroup className="form-group-flex">
                    <ControlLabel>Line style mode</ControlLabel>
                    <InputGroup>
                        <Select
                            value={mode}
                            clearable={false}
                ...
                {mode !== 'lines' && <>
                    <FormGroup className="form-group-flex">
                        <ControlLabel>Marker color</ControlLabel>
                        <InputGroup>
                            <ColorSelector
                                format="rgb"
                    ...
                    <FormGroup className="form-group-flex">
                        <ControlLabel>Marker size</ControlLabel>
                        <InputGroup style={{ maxWidth: 80 }}>
                            <DebouncedFormControl
                                type="number"
...
function ChartStyleEditor(props) {
    ...
    return (
        <>
            <div className="ms-wizard-form-separator"><span>Style</span></div>
            <Component
                {...props}
