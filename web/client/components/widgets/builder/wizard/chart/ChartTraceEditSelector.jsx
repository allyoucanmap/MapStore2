...
import { FormGroup, InputGroup, Button, Glyphicon, Tabs, Tab } from 'react-bootstrap';
    ...
    return (
        <>
            ...
            {editing && selectedTrace?.type !== 'pie' && <Tabs
                ...
                onSelect={setTab}
            >
                <Tab key="traces" eventKey="traces" title="Traces" />
                <Tab key="axis" eventKey="axis" title="Axis" />
            </Tabs>}
