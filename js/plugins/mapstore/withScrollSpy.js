...
module.exports = ({
  ...
  class WithInfiniteScroll extends React.Component {
    ...
    findScrollDomNode = () => {
        ...
        if (node && (closest || this.props.closest) && (this.props.querySelector || querySelector)) {
            return node.closest((this.props.querySelector || querySelector) || "*");
        }
        return node && ((this.props.querySelector || querySelector)
            ? node.querySelector((this.props.querySelector || querySelector))
                || this.props.querySelector && document.querySelector(this.props.querySelector)
            : node
        );
    }
    componentDidMount() {
    ...
    onScroll = () => {
        const div = this.findScrollDomNode();
        if (div) this.props.onScroll(div);
        if (div
