...
<div className={`mapstore-side-card${selected ? ' selected' : ''}${size ? ' ms-' + size : ''} ${className}`}
        ...
        <div className="ms-head">
            {props.isDraggable && props.connectDragSource && props.connectDragSource(<div className="mapstore-side-card-tool text-center">
                <div style={{ width: 10, overflow: 'hidden' }} ><Glyphicon glyph="menu-hamburger"/></div>
            </div>)}
