...
module.exports = {
    entry: assign({
        ...
        'GeoStory': path.join(__dirname, "js", "app"),
    ...
    plugins: [
        ...
        new LoaderOptionsPlugin({
            ...
            options: {
                postcss: {
                    plugins: [
                      require('postcss-prefix-selector')({prefix: '.GeoStory', exclude: ['.ms2', '.GeoStory', '[data-ms2-container]']})
                    ]
                },
                context: __dirname
            }
    ...
    module: {
        ...
        rules: [
            ...
            },
            {
                ...
                include: [path.join(__dirname, "js"), path.join(__dirname, "web", "client")]
            }, {
                test: /\.jsx?$/,
                ...
                include: [
                    ...
                    path.join(__dirname, "node_modules", "react-spring/renderprops")
                ]
            }
        ]
    },
